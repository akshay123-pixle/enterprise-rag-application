...
# Take documents → extract text → split into chunks → convert chunks into embeddings → store them in Qdrant so your chatbot can search them later.
import os
import sys
import uuid
import json
...
#     vector=[0.56,0.77,0.21],

#     payload={
#         "text":"Classes support OOP.",
#         "source":"python.pdf",
#         "source_type":"true"
#     }
# )
...
#                     [
#     ("Python is easy.", [0.12,0.45,0.98]),

#     ("Functions are reusable.", [0.88,0.11,0.32]),

#     ("Classes support OOP.", [0.56,0.77,0.21])
# ]
